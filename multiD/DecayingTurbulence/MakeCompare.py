...
def read_data(filetype, dirname, step):
    ...
    data_dict["magpre"] = 0.5*( data_dict["Bx"]**2 + data_dict["By"]**2 + data_dict["Bz"]**2)
    data_dict["kinene"] = 0.5*( data_dict["vx"]**2 + data_dict["vy"]**2 + data_dict["vz"]**2)
    data_dict["beta"] = data_dict["pre"]/data_dict["magpre"]
...
parser.add_argument("varname", type=str, help="variable to plot (rho, vx, vy, vz, P, Bx, By, Bz, magpre, kinene, beta)")
