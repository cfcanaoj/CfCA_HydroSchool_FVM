...
echo "wmv format"
ffmpeg -y -r 10 -start_number "$fstnum" -i "${dir}/${prename}%05d.png" -b 6000k -vcodec wmv2 -pass 1 -r 10 -an "${dir}/animation.wmv"

echo "mp4 format"
ffmpeg -y -r 10 -start_number "$fstnum" -i "${dir}/${prename}%05d.png" -vcodec libx264 -pix_fmt yuv420p -r 10 -an "${dir}/animation.mp4"
